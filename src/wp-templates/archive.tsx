...
const Component: FaustTemplate<GetArchiveQuery> = (props) => {
  const { title: siteTitle, description: siteDescription } =
    props.data?.generalSettings || { title: "default title", description: "default description" };
  const menuItems = props.data?.primaryMenuItems && props.data.primaryMenuItems.nodes;
